...
const items = [
    ...
    {
        id: 2,
        color: "bg-gradient-to-r from-blue-600 to-violet-700",
    ...
    {
        id: 4,
        color: "bg-gradient-to-r from-purple-800 to-red-700",
            ...
            <div className="h-[600vh] relative" ref={ref}>
                ...
                <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
                    <motion.div style={{ x }} className="flex">
                        <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-r from-purple-600 to-gray-600" />
                        {items.map((item) => (
